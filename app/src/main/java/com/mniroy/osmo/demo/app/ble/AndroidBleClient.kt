package com.mniroy.osmo.demo.app.ble
...
import com.mniroy.osmo.demo.ble.BleConnectionState
...
class AndroidBleClient(
    ...
    private fun consumeScanResult(result: ScanResult) {
        ...
        if (!name.contains("Osmo", ignoreCase = true) && !name.contains("Action", ignoreCase = true)) return
